...
public class GlobalErrorViewResolver extends DefaultErrorViewResolver {
  ...
  public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, Map<String, Object> model) {
    ...
    String errcode = Optional.ofNullable(model.get("status")).orElse("").toString();
    String path = Optional.ofNullable(model.get("path")).orElse("").toString();
    String massage = Optional.ofNullable(model.get("message")).orElse("").toString();
