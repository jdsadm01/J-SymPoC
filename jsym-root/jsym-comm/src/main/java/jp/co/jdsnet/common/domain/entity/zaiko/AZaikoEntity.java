...
public class AZaikoEntity implements EntityInterface {
  /** 代表会社識別コード */
  @Keyfield(index = 0)
  @Builder.Default
  ...
  @AutomapConstructor
  private AZaikoEntity(String daikaiskbcod, String kigbng, int zaisur, int zaikhokhasur,
      int sinjuckhasur, int sinsyasur, int chzkhasur, int ykesyakhasur, int sekzansur,
      int kdazansur, int todjucsur, int todsyasur, int tomjucsur, int tomsyasur) {
