...
public class GeneratedKakushaTokuisakiEntity implements EntityInterface {
  ...
  /** 指定伝返信封筒無フラグ */
  @Builder.Default
  private String stdrtnhutnasflg = "0";
