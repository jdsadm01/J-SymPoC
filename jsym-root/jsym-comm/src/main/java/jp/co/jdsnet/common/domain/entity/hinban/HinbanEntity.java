...
public class HinbanEntity implements EntityInterface {
  ...
  /** キット品代表品番フラグ */
  @Builder.Default
  private String kithindaihnbflg = "";
